            ...
            <div class="col d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item active" href="{{ route('Embalse.presa') }}">Presa</a></li>
            ...
            <div class="col">
                <div class="card shadow card-scroll">
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Embalses Tipo Presa</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered mb-0 sortable-table table-sm" data-table="embalse" style="font-size: 0.875rem;">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No hay embalses tipo presa</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
