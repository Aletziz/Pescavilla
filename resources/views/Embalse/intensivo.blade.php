                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="{{ route('Embalse.intensivo') }}">Intensivo</a></li>
                        </ul>
                    </div>
                    <div class="dropdown">
                        <button class="header-dropdown-btn-light" type="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="col">
                <div class="card shadow card-scroll">
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Embalses con Cultivo Intensivo</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered mb-0 sortable-table table-sm" data-table="embalse" style="font-size: 0.875rem;">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No hay embalses con cultivo intensivo</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
