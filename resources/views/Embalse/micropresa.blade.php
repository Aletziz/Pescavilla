                ...
                <div class="d-flex align-items-center gap-4">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item active" href="{{ route('Embalse.micropresa') }}">Micropresa</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow card-scroll">
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Embalses Tipo Micropresa</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered mb-0 sortable-table table-sm" data-table="embalse" style="font-size: 0.875rem;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($embalse->tipo_cultivo)
                                                <span class="badge bg-{{ $embalse->tipo_cultivo === 'intensivo' ? 'primary' : ($embalse->tipo_cultivo === 'extensivo' ? 'success' : 'warning') }}">
                                                    {{ ucfirst($embalse->tipo_cultivo) }}
                                                </span>
                                            @else
                                                N/A
                                            @endif
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No hay embalses tipo micropresa</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
